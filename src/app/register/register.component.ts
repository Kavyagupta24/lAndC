...
export class RegisterComponent implements OnInit {
  ...
  constructor(private router: Router, private global: GlobalDetails, private api: ApiServiceService,private soundService: SoundServiceService, public langModel: LanguageModel) {
